# -*- encoding: utf-8 -*-
# stub: money-rails 1.8.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<money>.freeze, ["~> 6.8.1"])
      s.add_runtime_dependency(%q<monetize>.freeze, ["~> 1.6.0"])
      ...
      s.add_development_dependency(%q<database_cleaner>.freeze, ["< 1.4.0", ">= 0.8.0"])
    else
      s.add_dependency(%q<money>.freeze, ["~> 6.8.1"])
      s.add_dependency(%q<monetize>.freeze, ["~> 1.6.0"])
      ...
      s.add_dependency(%q<database_cleaner>.freeze, ["< 1.4.0", ">= 0.8.0"])
    end
  else
    s.add_dependency(%q<money>.freeze, ["~> 6.8.1"])
    s.add_dependency(%q<monetize>.freeze, ["~> 1.6.0"])
